...
class ConditionsControllerTest < ActionController::TestCase
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post :create, condition: { icd_code: @condition.icd_code, name: @condition.name, patient_visit_id: @condition.patient_visit_id }
    end
  ...
  test "should update condition" do
    patch :update, id: @condition, condition: { icd_code: @condition.icd_code, name: @condition.name, patient_visit_id: @condition.patient_visit_id }
    assert_redirected_to condition_path(assigns(:condition))
  end
