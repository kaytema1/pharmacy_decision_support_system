...
class DiagnosesControllerTest < ActionController::TestCase
  ...
  test "should create diagnosis" do
    assert_difference('Diagnosis.count') do
      post :create, diagnosis: { diagnosis: @diagnosis.diagnosis, patient_visit_id: @diagnosis.patient_visit_id }
    end
  ...
  test "should update diagnosis" do
    patch :update, id: @diagnosis, diagnosis: { diagnosis: @diagnosis.diagnosis, patient_visit_id: @diagnosis.patient_visit_id }
    assert_redirected_to diagnosis_path(assigns(:diagnosis))
  end
